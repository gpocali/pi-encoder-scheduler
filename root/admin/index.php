    ...
    <div class="live-monitor">
        <?php foreach ($live_status as $tag_id => $status): ?>
            <div class="monitor-card">
                ...
                ?>
                <div class="monitor-thumb" onclick="showPreview('<?php echo $file_url; ?>', '<?php echo $asset['mime_type']; ?>')" style="display:grid; place-items:center; overflow:hidden; cursor:pointer;">
                    <?php if ($asset): ?>
        ...
        <table>
            ...
            <tbody>
                <?php foreach ($events as $ev):
                    ...
                    ?>
                    <tr>
                        <td><span style="color:<?php echo $status_color; ?>; font-weight:bold;"><?php echo $status; ?></span>
                        </td>
                        <td>
                            <?php
                            $prio_label = 'Normal';
