...
<head>
    ...
    <style>
        ...
        .card { background: var(--card-bg); padding: 2em; border-radius: 8px; margin-bottom: 2em; }
        h2 { margin-top: 0; }
        input { padding: 0.8em; background: #2c2c2c; border: 1px solid var(--border-color); color: #fff; border-radius: 4px; width: 100%; box-sizing: border-box; margin-bottom: 10px; }
        ...
        .success { background: rgba(3, 218, 198, 0.2); color: var(--secondary-color); }
        .error { background: rgba(207, 102, 121, 0.2); color: var(--error-color); }
    </style>
</head>
<body>
    <div class="container">
